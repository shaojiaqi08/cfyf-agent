<template>
    <div class="position-pane-container" ref="container">
        <el-button
            v-if="
                $checkAuth('/sale/position_and_authority/sales_position/store')
            "
            class="add-button"
            type="primary"
                ...
                <div class="desc-wrap flex-between">
                    ...
                    <div class="flex-center">
                        <el-tooltip
                            ...
                            v-if="
                                $checkAuth(
                                    '/sale/position_and_authority/sales_position/delete'
                                )
                            "
                            placement="top"
                        >
                        ...
                        <el-button
                            ...
                            v-if="
                                $checkAuth(
                                    '/sale/position_and_authority/sales_position/update'
                                )
                            "
                            size="small"
