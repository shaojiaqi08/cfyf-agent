...
<script>
import { paytimeTypes } from '../../config'
export default {
  data() {
    return {
      popoverWidth: 305,
  ...
  computed: {
    hasValue() {
      return (this.obj.unit && this.obj.min) || (this.obj.unit && this.obj.max) || this.obj.unit === '5'
    }
  },
  methods: {
    clear() {
    ...
    submit() {
      ...
      this.$emit('search', { pay_period: this.obj })
      this.visible = false
    }
  }
}
