    ...
    <div class="auto-scroll">
      ...
      >
        ...
        <el-form-item label="保险公司" prop="source_supplier_id">
          <el-select
            v-model="formdata.source_supplier_id"
            filterable
            ref="select"
            class="form-select"
            placeholder="请选择保险公司名称"
            @change="chnageGS"
          >
            <el-option
        ...
        <el-form-item label="保额" prop="guarantee_quota_value">
          <el-input
            class="form-medium-input"
            placeholder="请输入保额"
            type="number"
            @change="formdata.guarantee_quota_value < 0 && (formdata.guarantee_quota_value = '')"
            v-model="formdata.guarantee_quota_value"
          ></el-input>
          <el-select
            class="form-small-select"
        ...
        <el-form-item label="保障期限" prop="guarantee_period_value">
          ...
          >
            <el-option
              v-for="item in guaranteeTimeTypes"
              :key="item.value"
              :label="item.label"
              :value="item.value"
            >{{ item.label }}</el-option>
...
export default {
  ...
  methods: {
    ...
    initForm() {
      ...
      this.formdata.guarantee_period_unit = this.diyData.guarantee_period.split(
        '_'
      )[1]
      this.formdata.guarantee_period_value = this.diyData.guarantee_period.split(
        '_'
      )[0]
    ...
    getProductCompanyList() {
      getProductCompanyList().then((res) => {
