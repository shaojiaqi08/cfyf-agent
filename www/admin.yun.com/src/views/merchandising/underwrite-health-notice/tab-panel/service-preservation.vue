      ...
      <div style="width: 280px" v-if="!collapse" class="underwriting-contents-rule-left">
        ...
        <el-scrollbar>
          <el-form inline :modal="formData" @submit.native.prevent label-position="top">
              ...
              <el-form-item label="电子回访/电话回访">
                <el-input v-model="formData.return_visit" placeholder="请输入搜索关键字"></el-input>
              </el-form-item>
              <el-form-item label="联系方式变更(电话/地址)">
                <el-input v-model="formData.contact_way_change" placeholder="请输入搜索关键字"></el-input>
              </el-form-item>
              <el-form-item label="基本信息变更(证件有效期)">
                <el-input v-model="formData.basic_info_change" placeholder="请输入搜索关键字"></el-input>
              </el-form-item>
              <el-form-item label="续期账户变更">
                <el-input
                  v-model="formData.renewal_account_change"
                  placeholder="请输入搜索关键字"
                ></el-input>
              </el-form-item>
              <el-form-item label="补充健康告知">
                <el-input
                  v-model="formData.health_report"
                  placeholder="请输入搜索关键字"
                ></el-input>
              </el-form-item>
              <el-form-item label="受益人变更">
                <el-input
                  v-model="formData.beneficiary_change"
                  placeholder="请输入搜索关键字"
                ></el-input>
              </el-form-item>
              <el-form-item label="犹豫期退保/退保">
                <el-input
                  v-model="formData.insurance_refund"
                  placeholder="请输入搜索关键字"
                ></el-input>
              </el-form-item>
              <el-form-item label="申请纸质保单">
                <el-input
                  v-model="formData.paper_policy"
                  placeholder="请输入搜索关键字"
                ></el-input>
              </el-form-item>
              <el-form-item label="发票申请">
                <el-input
                  v-model="formData.invoice_apply"
                  placeholder="请输入搜索关键字"
                ></el-input>
              </el-form-item>
              <el-form-item label="增加/退保投保人豁免">
                <el-input
                  v-model="formData.policy_holder_exempt"
                  placeholder="请输入搜索关键字"
                ></el-input>
              </el-form-item>
              <el-form-item label="加保/减保">
                <el-input v-model="formData.add_subtract_insurance" placeholder="请输入搜索关键字"></el-input>
              </el-form-item>
              <el-form-item label="增加第二投保人">
                <el-input v-model="formData.second_policy_holder" placeholder="请输入搜索关键字"></el-input>
              </el-form-item>
              <el-form-item label="变更投保人">
                <el-input v-model="formData.policy_holder_change" placeholder="请输入搜索关键字"></el-input>
              </el-form-item>
              <el-form-item label="增加万能账户">
                <el-input v-model="formData.universal_account" placeholder="请输入搜索关键字"></el-input>
              </el-form-item>
              <el-form-item label="保单贷款">
                <el-input v-model="formData.policy_loan" placeholder="请输入搜索关键字"></el-input>
              </el-form-item>
              <el-form-item label="其他规则">
                <el-input v-model="formData.other_rule" placeholder="请输入搜索关键字"></el-input>
              </el-form-item>
              <el-form-item label="备注">
                <el-input v-model="formData.remarks" placeholder="请输入搜索关键字"></el-input>
              </el-form-item>
          </el-form>
        </el-scrollbar>
...
<script>
import { getservicePreservationList, getUnderwriteRuleDetail} from '@/apis/modules/underwriting'
export default {
