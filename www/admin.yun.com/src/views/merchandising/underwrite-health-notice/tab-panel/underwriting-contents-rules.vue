    ...
    <div class="underwriting-contents-rule">
        ...
        <div class="underwriting-all-rule-box">
            <div
                style="width: 280px"
                v-if="!collapse"
                class="underwriting-contents-rule-left"
            >
                <div>险种筛选</div>
                ...
                <el-scrollbar>
                    ...
                    >
                        ...
                        <el-form-item label="是否有健康告知">
                            <el-input
                                v-model="formData.have_health_notice"
                                placeholder="请输入搜索关键字"
                            />
                        </el-form-item>
                        <el-form-item label="是否有智能核保">
                            <el-input
                                v-model="formData.intelligent_underwriting"
                                placeholder="请输入搜索关键字"
                            />
                        </el-form-item>
                        <el-form-item label="是否有人工核保">
                            <el-input
                                v-model="formData.manual_underwriting"
                                placeholder="请输入搜索关键字"
                            />
                        </el-form-item>
                        <el-form-item label="人核方式">
                            <el-input
                                v-model="formData.manual_underwriting_way"
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="人核具体条件">
                            <el-input
                                v-model="formData.manual_underwriting_operation"
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="是否可以支持医保卡外借">
                            <el-input
                                v-model="formData.medicare_card_loan"
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="人工核保时效">
                            <el-input
                                v-model="
                                    formData.manual_underwriting_time_limit
                                "
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="人核拒保是否留痕">
                            <el-input
                                v-model="
                                    formData.manual_underwriting_refuse_leave_trace
                                "
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="人核结论查询方式">
                            <el-input
                                v-model="
                                    formData.manual_underwriting_conclusion_query_way
                                "
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="人核结论有效期">
                            <el-input
                                v-model="
                                    formData.manual_underwriting_conclusion_expire_date
                                "
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="人工核保通过后如何投保">
                            <el-input
                                v-model="
                                    formData.manual_underwriting_pass_how_to_insure
                                "
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="人核生日单保费计算">
                            <el-input
                                v-model="
                                    formData.manual_underwriting_birthday_order_premium
                                "
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="人核结论是否会体现在保单上">
                            <el-input
                                v-model="
                                    formData.manual_underwriting_conclusion_on_policy
                                "
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="核保批单申请">
                            <el-input
                                v-model="
                                    formData.underwriting_endorsement_application
                                "
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="是否支持投保人问题核保">
                            <el-input
                                v-model="formData.applicant_issue_underwriting"
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="是否支持复议">
                            <el-input
                                v-model="formData.support_reconsider"
                                placeholder="请输入搜索关键字"
                            ></el-input>
                        </el-form-item>
                    </el-form>
    ...
    data () {
        return {
            ...
            tableData: [
                ...
                { name: '是否有健康告知', key: 'have_health_notice' },
                { name: '是否有智能核保', key: 'intelligent_underwriting' },
                { name: '是否有人工核保', key: 'manual_underwriting' },
