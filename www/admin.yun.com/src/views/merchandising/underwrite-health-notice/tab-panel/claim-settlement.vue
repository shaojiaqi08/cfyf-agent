...
// B端接口：
// 三、理赔商品列表：
// 接口：agent/proxy/health_notice/claim-settlement/product-list
// 请求方式：GET
// 参数：product_name：商品名称，is_reverse：是否反向，默认0-否，1-是  insurance_class：险种类型，多选使用英文逗号连接

// 四、理赔详情：
// 接口：agent/proxy/health_notice/claim-settlement/detail
// 请求方式：GET
// 参数：id:数据ID
import {
...
export default {
  ...
  methods: {
    ...
    requestList() {
      ...
      getClaimPreservationList(params)
        .then((res) => {
