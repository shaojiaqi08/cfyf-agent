<template>
    <div class="home-page">
        <div class="page-container">
            ...
            <div
                class="announcement-sector"
                :style="bannerList.length ? '' : 'padding-top: 20px;'"
            >
                <template v-for="item in filterAnnouncementList">
                    <div
                        ...
                        :style="{
                            width:
                                (100 / filterAnnouncementList.length <= 50
                                    ? 100 / filterAnnouncementList.length -
                                      1 +
                                      0.5
                                    : 100 / filterAnnouncementList.length) +
                                '%',
                    ...
                    >
                        ...
                        <div class="sector-content">
                            <div
                                class="sector-row"
                                :class="{
                                    is_top: post.is_emphasis,
                                    is_read: post.is_read != 0,
                                }"
                                v-for="post in item.data"
                                :key="post.announcement_no"
                                @click="toDetail(post.announcement_no)"
                            >
            ...
            <div
                ...
                v-if="hasStatisticsAuth"
                v-loading="performanceLoading"
            >
                <div class="common-sector-header">
                    <div class="header-left-wrap">
                        <span class="title"
                            ><span class="title-text">业绩统计</span></span
                        >
                        <div class="performance-tabs">
                            <el-tabs
                                v-model="activePerformanceName"
                                @tab-click="performanceChange"
                                class="sector-header-tabs"
                            >
                                <el-tab-pane
                                    :label="item.name + '业绩'"
                ...
                <div class="performance-main">
                    <div class="common-main">
                        <div class="main-wrap">
                            ...
                            <div class="main-count">
                                {{
                                    performanceStatistics.actual_underwrite_total_count
                                }}
                            </div>
                        </div>
                    </div>
                    <div class="common-main">
                        <div class="main-wrap">
                            ...
                            <div class="main-count">
                                {{ performanceStatistics.cumulative_customer }}
                            </div>
                        </div>
                    </div>
                    <div class="common-main">
                        <div class="main-wrap">
                            ...
                            <div class="main-count">
                                {{
                                    performanceStatistics.actual_underwrite_total_premium
                                }}
                            </div>
                        </div>
                    </div>
            ...
            <div
                class="sales-top"
                v-if="hasStatisticsAuth"
                v-loading="salesTopLoading"
            >
                <div class="common-sector-header">
                    <div class="header-left-wrap">
                        <span class="title"
                            ><span class="title-text">商品销量TOP5</span></span
                        >
                    </div>
                    <div>
                        <span
                ...
                <div class="sales-main">
                    ...
                    >
                        ...
                        <el-table-column
                            label="销量（个）"
                            prop="underwrite_quantity"
                            align="center"
                            width="100px"
                        ></el-table-column>
                        <el-table-column
                            label="总保费（元）"
                            prop="underwrite_premium"
                            align="center"
                            width="150px"
                        ></el-table-column>
                    </el-table>
            ...
            <div
                ...
                v-if="hasStatisticsAuth"
                v-loading="insuranceClassLoading"
            >
                <div class="common-sector-header">
                    <div class="header-left-wrap">
                        <span class="title"
                            ><span class="title-text">险种销售分析</span></span
                        >
                    </div>
                    <div>
                        <span
                ...
                <div class="insurance-type-main">
                    <div
                        ...
                        id="pieChart"
                        ref="pieChart"
                        v-if="filterInsuranceClassList.length > 0"
                    ></div>
                    <div v-else class="no-insurance-data">暂无数据</div>
                </div>
            </div>
        </div>
    </div>
...
import { pieChartInsuranceTypeArray } from '@/enums/common'
    ...
    methods: {
        ...
        renderChart() {
            ...
            this.pieChart
                ...
                .color('insurance_class', (val) => {
                    const obj = pieChartInsuranceTypeArray.find(el => el.value === val)
                    return obj.color
                })
