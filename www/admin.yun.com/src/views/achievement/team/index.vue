  ...
  <div class="order-container page-container">
    <div class="header">
      <el-tabs class="tabs" v-model="tabIndex" @tab-click="tabChange">
        ...
        <el-tab-pane name="rank" label="业绩排行" v-if="$checkAuth('/team_performance/personal_rank')"></el-tab-pane>
        <el-tab-pane name="statistics" label="商品统计" v-if="$checkAuth('/team_performance/insurance_class_rank') || $checkAuth('/team_performance/product_rank')"></el-tab-pane>
      </el-tabs>
...
<!--        </div>-->
      ...
      <el-table :data="list"
        ...
        <el-table-column label="团队" prop="sales_team_name" align="center" width="120px" fixed="left"></el-table-column>
        <el-table-column label="出单人" prop="sales_real_name" align="center" width="120px" fixed="left"></el-table-column>
