<template>
  <el-scrollbar class="scrollbar" style="height: 94vh;">
    ...
    <div class="pl16 pr16" v-if="$checkAuth('/company_performance/company/insurance_class_rank')">
    ...
    <div class="pl16 pr16" v-if="$checkAuth('/company_performance/company/product_rank')">
