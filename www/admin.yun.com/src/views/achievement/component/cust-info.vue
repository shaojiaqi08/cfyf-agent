<template>
    <div class="item-block">
        <div class="item" v-if="type === '2' && data.policy_sn">
            <div class="label">保单号：</div>
            <div class="content">{{ data.policy_sn }}</div>
        </div>
        <div class="item">
        ...
        <div class="item">
            ...
            <div class="content">
                {{
                    data.certificate_long_term === ''
                        ? '-'
                        : data.certificate_long_term === 0
                        ? '非长期'
                        : '长期'
                }}
            </div>
        ...
        <div class="item">
            ...
            <div class="content">
                {{
                    data.certificate_start_at
                        ? formatDate(
                              data.certificate_start_at * 1000,
                              'yyyy-MM-dd'
                          )
                        : '-'
                }}
        ...
        <div class="item">
            ...
            <div class="content">
                {{
                    data.certificate_end_at
                        ? formatDate(
                              data.certificate_end_at * 1000,
                              'yyyy-MM-dd'
                          )
                        : '-'
                }}
        ...
        <template v-if="type !== '3'">
            ...
            <div class="item">
                ...
                <div class="content">
                    {{ data.mobile && data.mobile != '0' ? data.mobile : '-' }}
                </div>
            </div>
            ...
            <template v-if="type === '1'">
                <div class="item">
                    ...
                    <div class="content">
                        {{
                            (data.policy_renewal &&
                                data.policy_renewal.payment_bank_name) ||
                            '-'
                        }}
                    </div>
                </div>
                <div class="item">
                    ...
                    <div class="content">
                        {{
                            (data.policy_renewal &&
                                data.policy_renewal.payment_account) ||
                            '-'
                        }}
                    </div>
                </div>
                <div class="item">
                    ...
                    <div class="content">
                        {{
                            data.policy_renewal &&
                            data.policy_renewal.payment_bank_province_name
                                ? data.policy_renewal
                                      .payment_bank_province_name +
                                  data.policy_renewal.payment_bank_city_name
                                : '-'
                        }}
                    </div>
                </div>
