    ...
    <div class="order-detail-container">
        <div class="header">
            ...
            <el-button
                ...
                :loading="downloading"
                v-if="
                    baseInfo.policy_file_url &&
                    $checkAuth(`/${$route.name.slice(0, -7)}/policy_file_url`)
                "
            ...
            <el-scrollbar>
                ...
                <template v-if="$checkAuth(`${perPreFix}base`)">
                    ...
                    <div class="item-block" v-loading="baseInfoLoading">
                        ...
                        <div class="item">
                            ...
                            <div class="content">
                                {{ baseInfo.guarantee_period_desc || '-' }}
                            </div>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <div class="content">
                                {{
                                    baseInfo.policy_plan &&
                                    baseInfo.policy_plan.guarantee_start_at
                                        ? formatDate(
                                              baseInfo.policy_plan
                                                  .guarantee_start_at * 1000,
                                              'yyyy-MM-dd'
                                          )
                                        : '-'
                                }}
                        ...
                        <div class="item">
                            ...
                            <div class="content">
                                {{ baseInfo.pay_channel_str || '-' }}
                            </div>
                        </div>
                        <div class="item">
                            <div class="label">支付失败原因：</div>
                            <div class="content">
                                {{ baseInfo.pay_failed_reason || '-' }}
                            </div>
                        </div>
                        <div class="item">
                            <div class="label">退保类型：</div>
                            <div class="content">
                                {{ baseInfo.surrender_type_str || '-' }}
                            </div>
                        </div>
                        <div class="item">
                            <div class="label">退保时间：</div>
                            <div class="content">
                                {{ baseInfo.surrender_at_str || '-' }}
                            </div>
                        </div>
                ...
                <template v-if="$checkAuth(`${perPreFix}holder_recognize`)">
                    ...
                    <div v-loading="customerInfoLoading">
                        ...
                        <cust-info
                            :data="customerInfo.policy_holder_info"
                            v-if="
                                tabIndex === '1' &&
                                customerInfo.policy_holder_info
                            "
                        ></cust-info>
                        <template
                            v-for="(
                                item, index
                            ) in customerInfo.policy_recognizee_policies"
                        ...
                        >
                            <div class="mb10 mt10">
                                <span class="mr10" style="font-size: 14px"
                                    >被保人{{ index + 1 }}的受益人类型</span
                                >
                                <el-radio-group
                                    :value="customerInfo.is_legal_beneficiary"
                                >
                ...
                <template v-if="$checkAuth(`${perPreFix}insurances`)">
                    ...
                    <div v-loading="insuranceInfoLoading">
                        <el-table
                            ...
                            border
                            stripe
                            :data="insuranceInfo.policy_product_insurances"
                        >
                            <el-table-column
                                label="险种名称"
                                prop="name"
                            ...
                            <el-table-column
                                label="结论"
                                prop="risk_conclusion_str"
                            ></el-table-column>
                            <el-table-column
                                label="备注"
                                prop="risk_conclusion_remark"
                            ></el-table-column>
                        </el-table>
                        <div
                            class="item-block"
                ...
                <!--人工核保信息-->
                <template
                    v-if="$checkAuth(`${perPreFix}manpower`) && manPowerInfo"
                >
                    <h3>人工核保信息</h3>
                    <div class="item-block">
                        ...
                        <div class="item">
                            ...
                            <div class="content">
                                {{
                                    manPowerInfo.base.add_time
                                        ? formatDate(
                                              manPowerInfo.base.add_time * 1000,
                                              'yyyy-MM-dd'
                                          )
                                        : '-'
                                }}
                        ...
                        <div class="item">
                            ...
                            <div class="content">
                                {{ manPowerInfo.base.result || '-' }}
                            </div>
                        </div>
                        <div class="item">
                            <div class="label">人核状态：</div>
                            <div class="content">
                                {{ manPowerInfo.base.status || '-' }}
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="content">
                                <el-link
                                    v-if="manPowerInfo.base.underwrite_url"
                                    type="primary"
                                    @click="
                                        copyLink(
                                            manPowerInfo.base.underwrite_url
                                        )
                                    "
                                    >复制链接</el-link
                                >
                    ...
                    <div class="mb10">
                        ...
                        <div>
                                ...
                                <el-table-column label="操作">
                                    <template slot="header">
                                        <div class="flex flex-align-center">
                                            ...
                                            <el-link
                                                v-if="
                                                    manPowerFileList.length >
                                                        0 &&
                                                    $checkAuth(
                                                        '/my_performance/manpower/manpower_zip'
                                                    )
                                                "
                                                type="primary"
                                                @click="downloadAllFile"
                                                :disabled="manPowerDownloading"
                                                ><i
                                                    class="el-icon-loading"
                                                    v-if="manPowerDownloading"
                            ...
                            <div
                                :title="custInfoCollapse ? '折叠' : '展开'"
                                v-if="
                                    this.manPowerInfo &&
                                    manPowerInfo
                                        .policy_manpower_underwriting_file
                                        .length > collapseCount
                                "
                                class="cust-info-collapse-block"
                                @click="custInfoCollapse = !custInfoCollapse"
                            >
                                <i
                                    :class="`${
                                        custInfoCollapse
                    ...
                    <div>
                        ...
                        <el-timeline>
                            ...
                            >
                                <div
                                    class="timeline-item"
                                    :class="{ pointer: item.data }"
                                    @click="showManPowerDetail(item)"
                                >
                                    <i
                                        v-if="item.data"
                                        class="el-icon-info"
                ...
                <template v-if="$checkAuth(`${perPreFix}visit_info`)">
                    ...
                    <div class="item-block" v-loading="visitInfoLoading">
                        ...
                        <div class="item">
                            ...
                            <div class="content">
                                {{ visitInfo.visit_way_name || '-' }}
                            </div>
                        </div>
                        <div class="item">
                            <div class="label">回访失败原因：</div>
                            <div class="content">
                                {{ visitInfo.visit_ques_reason || '-' }}
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="content">
                                {{
                                    visitInfo.receipt_at
                                        ? formatDate(
                                              visitInfo.receipt_at * 1000,
                                              'yyyy-MM-dd'
                                          )
                                        : '-'
                                }}
                        ...
                        <div class="item">
                            <div class="label">最近同步时间：</div>
                            <div class="content">
                                {{ visitInfo.visit_sync_at || '-' }}
                            </div>
                        </div>
                        <el-divider></el-divider>
                    </div>
                ...
                <template v-if="$checkAuth(`${perPreFix}sales_info`)">
                    ...
                    <div class="item-block" v-loading="salesInfoLoading">
                        <div class="item">
                            ...
                            <div class="content">
                                {{ salesInfo.sales_company_name || '-' }}
                            </div>
                        </div>
                        <div class="item">
                            <div class="label">所属团队：</div>
                            <div class="content">
                                {{ salesInfo.sales_team_name || '-' }}
                            </div>
                        </div>
                        <div class="item">
                            <div class="label">出单人：</div>
                            <div class="content">
                                {{ salesInfo.sales_real_name || '-' }}
                            </div>
                        </div>
                    </div>
                    <el-divider></el-divider>
                ...
                <template v-if="$checkAuth(`${perPreFix}renewal_info`)">
                    ...
                    <div class="item-block" v-loading="historyLoading">
                        <div class="item">
                            ...
                            <div class="content">
                                {{
                                    getDataInfo.current_renewal_stage
                                        .renewal_status_name
                                }}
                            </div>
                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="content">
                                {{
                                    getDataInfo.current_renewal_stage.pay_at ===
                                        0 ||
                                    getDataInfo.current_renewal_stage.pay_at ===
                                        ''
                                        ? ''
                ...
                <template v-if="$checkAuth(`${perPreFix}renewal_info`)">
                    ...
                    <div v-loading="historyLoading">
                        <el-table
                            ...
                            border
                            stripe
                            :data="getDataInfo.renewal_stage_history"
                        >
                            <el-table-column
                                label="应续日期"
                                prop="renewal_date_format"
                            ></el-table-column>
                            <el-table-column
                                label="续保状态"
                                prop="renewal_status_name"
                            ></el-table-column>
        ...
        <el-dialog
            :title="manPowerDetail.title"
            :visible.sync="manPowerDialogVisible"
            :width="
                manPowerDetail.type === 'waiting_counteroffer_reply'
                    ? '1000px'
                    : '1200px'
            "
            :top="
        ...
        >
            <el-tabs
                v-model="activeName"
                v-if="manPowerDetail.type === 'customer_info'"
            >
                <el-tab-pane
                    :label="
                        (item.role == 'recognizee' ? '被保人-' : '投保人-') +
                        item.name
                    "
                    v-for="(item, index) in manPowerObj"
                    :name="'' + index"
                    :key="'recognizee' + index"
                >
                    <template>
                        <div class="manpower-block block">
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    {{
                                        item.answer.first_morbidity_at
                                            ? formatDate(
                                                  item.answer
                                                      .first_morbidity_at *
                                                      1000,
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    {{
                                        item.answer.last_morbidity_at
                                            ? formatDate(
                                                  item.answer
                                                      .last_morbidity_at * 1000,
                                                  'yyyy-MM-dd hh:mm:ss'
                                              )
                                            : '-'
                                    }}
                            ...
                            <div class="item" style="width: 100%">
                                ...
                                <div class="content">
                                    {{ item.answer.symptoms || '-' }}
                                </div>
                            </div>
                            <div class="item">
                                <div class="label">疾病发作持续时间：</div>
                                <div class="content">
                                    {{ item.answer.disease_duration || '-' }}
                                </div>
                            </div>
                            <div class="item">
                                <div class="label">疾病发作次数或频率：</div>
                                <div class="content">
                                    {{ item.answer.disease_frequency || '-' }}
                                </div>
                            </div>
                            <div class="item">
                                <div class="label">是否需要治疗：</div>
                                <div class="content">
                                    {{ item.answer.still_treatment || '-' }}
                                </div>
                            </div>
                            <div class="item">
                                ...
                                <div class="content">
                                    {{
                                        item.answer.last_treatment_at
                                            ? formatDate(
                                                  item.answer
                                                      .last_treatment_at * 1000,
                                                  'yyyy-MM-dd'
                                              )
                                            : '-'
                                    }}
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    {{
                                        item.answer.medication_therapeutic ||
                                        '-'
                                    }}
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    {{ item.answer.physics_therapeutic || '-' }}
                                </div>
                            </div>
                            <div class="item">
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    {{
                                        item.answer.other_therapeutic_remark ||
                                        '-'
                                    }}
                                </div>
                            </div>
                            <div class="item">
                                ...
                                <div class="content">
                                    {{ item.answer.treatment_effects || '-' }}
                                </div>
                            </div>
                            <div class="item" style="width: 100%">
                                <div class="label">其它说明：</div>
                                <div class="content">
                                    {{ item.answer.other_illustrate || '-' }}
                                </div>
                            </div>
                        </div>
                    </template>
                    <template v-if="manPowerDetail.type === 'customer_answer'">
                        <div :key="index" v-for="(item, index) in manPowerObj">
                            ...
                            >
                            <el-divider
                                v-if="index !== manPowerObj.length - 1"
                            ></el-divider>
                        </div>
                    </template>
                </el-tab-pane>
            ...
            <template
                v-else-if="manPowerDetail.type === 'manpower_result_ques'"
            >
                <div :key="index" v-for="(item, index) in manPowerObj">
                    <span class="flex"
                        ><span style="font-weight: bold">Q：</span
            ...
            <template
                v-else-if="
                    manPowerDetail.type === 'work_notification' ||
                    manPowerDetail.type === 'result_notification'
                "
            >
            ...
            <template v-else-if="manPowerDetail.type === 'manpower_result'">
                ...
                <template v-else>
                    <div
                        :key="index"
                        v-for="(item, index) in manPowerDetail.data"
                    >
                        <span>{{ item.content }}</span>
                        <el-divider
                            v-if="index !== manPowerDetail.data.length - 1"
                        ></el-divider>
                    </div>
                </template>
            </template>
            ...
            <template
                v-else-if="manPowerDetail.type === 'waiting_counteroffer_reply'"
            >
                <iframe
                    v-if="manPowerDialogVisible"
            ...
            <template
                v-else-if="
                    manPowerDetail.type === 'counteroffer_all_confirming' ||
                    manPowerDetail.type === 'counteroffer_all_confirmed'
                "
            >
                <el-table
                    :data="manPowerDetail.data"
                    :show-header="false"
                    border
                    stripe
                >
                        ...
                        <template v-slot="{ row }">
                            <span>
                                ...
                                <span
                                    :style="{
                                        color:
                                            row.conclusion === 'accept'
                                                ? 'blue'
                                                : row.conclusion === 'refuse'
                                                ? 'red'
                                                : null,
                                    }"
                                    >{{ row.conclusion_str }}</span
                                >
                            </span>
                        </template>
                    </el-table-column>
