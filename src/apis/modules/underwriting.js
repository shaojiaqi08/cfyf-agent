...
// 获取健告产品详情
export const getHealthNoticeDetail = params => get('/agent/health_notice/list', params)
// 获取核保产品详情
...
// 获取健告产品列表
export const getHealthNoticeProductList = params => get('/agent/health_notice/product_name/list', params)
// 根据产品名称删除健告信息
...
// 核保规则列表
export const getUnderwriteRuleList = params => get('/agent/health_notice/underwrite-rule/list', params)
// 核保规则详情
export const getUnderwriteRuleDetail = params => get('/agent/health_notice/underwrite-rule/detail', params)
// 获取对比表的字段配置
