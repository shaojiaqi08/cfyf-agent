<template>
    <div class="rate-container page-container">
        <div class="header">
            ...
            <el-button v-if="$checkAuth('/rate/commission_management/batch_create') && tabIndex === 'commission-rate'" type="primary" @click="openRateDialog"><i class="iconfont iconxiao16_shezhi mr4"></i>批量设置佣金费率</el-button>
        </div>
        <div class="content">
