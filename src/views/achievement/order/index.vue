<template>
    <div class="order-container">
        <div class="header">
            订单
            <el-input placeholder="搜索单号或投被保人信息">
        ...
        <el-dialog top="5vh"
            ...
            <div class="card">
                ...
                <el-row>
                    <el-col :span="12">
                        投保单号<span>213412312313</span>
                    </el-col>
                    <el-col :span="12">
                        保单号<span>23123412343452345</span>
                    </el-col>
                </el-row>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            checkNeedScroll() {
                ...
                const {offsetWidth: warpWidth} = this.$refs.dataRow.querySelector('.scroll-wrap')
